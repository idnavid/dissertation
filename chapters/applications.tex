...
Pyknograms were the solution to a long-lasting effort of developing a robust overlap detection method for noisy conditions (see Section~\ref{sec:ovldet} in Chapter~\ref{chapter:front-end}). 
