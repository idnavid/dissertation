...
\end{itemize}
\section{Background: Why overlap detection?}
...
Readers that feel comfortable with the concepts of speaker verification, specifically the use of GMM-UBM setups for speaker for verification, may skip to Sect.~\ref{ssec:ch2_ssecGMMUBM}.
