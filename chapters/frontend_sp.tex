...
The performance of the proposed detection metric is evaluate on overlapped speech on the GRID database~\cite{SSC_link} (see Sect.\ref{ssec:exp_pykno} for more details on GRID). 
